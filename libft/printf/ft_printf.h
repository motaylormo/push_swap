...
int				pf_write_integer(uintmax_t num, int base, int hexcase);
int				pf_print_string(va_list ap, t_fwplt fwplt);
int				pf_print_char(va_list ap, t_fwplt fwplt);
int				pf_print_unsigned_integer_base(va_list ap, t_fwplt fwplt);
int				pf_print_signed_integer(va_list ap, t_fwplt fwplt);
int				pf_print_floating_point(va_list ap, t_fwplt fwplt);
int				pf_print_address(va_list ap, t_fwplt fwplt);
int				pf_print_percent_sign(va_list ap, t_fwplt fwplt);
